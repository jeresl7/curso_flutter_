            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                  color: Color.fromARGB(255, 17, 186, 132),
          ...
          const Expanded(
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Text(
                    'Estoy practicando, esto solo es una nota de ejemplo, no te emociones mucho, mi nombre es Jeremy y soy estudiante de ing en sistemas'),
              ),
            ),
          ),
          const SizedBox(height: 20),
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: () {},
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(const Color.fromARGB(255, 18, 205, 62)),
                  ...
                  child: Text(
                    'Edit',
                    style: TextStyle(
                      color: const Color.fromARGB(255, 33, 18, 255),
                    ),
                  ),
                ),
              ),
